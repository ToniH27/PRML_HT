...
C = np.array([  [1,2,3],[3,4,5],[6,7,8],[1,1,1],[2,2,2]  ]) # NOTE: this crashes if it is any shorter than 5 rows (Nx3), also the requirements.txt is not done yet...
